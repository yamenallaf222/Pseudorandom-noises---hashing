...
public static partial class Noise 
{
    ...
    {
		public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash, int frequency) {
			LatticeSpan4 x = default(L).GetLatticeSpan4(positions.c0, frequency), z = default(L).GetLatticeSpan4(positions.c2, frequency);
    ...
    {
		public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash, int frequency) {
			LatticeSpan4 x = default(L).GetLatticeSpan4(positions.c0, frequency), y = default(L).GetLatticeSpan4(positions.c1, frequency), z = default(L).GetLatticeSpan4(positions.c2, frequency);
			SmallXXHash4 
			...
			return g.EvaluateCombined(lerp(
						lerp(
							...
							lerp(g.Evaluate(h00.Eat(z.p0), x.g0, y.g0, z.g0),
						...
						lerp(
							lerp(g.Evaluate(h10.Eat(z.p0), x.g1, y.g0, z.g0),
